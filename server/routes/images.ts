...
import { validateModelForBaseURL, validateStyleForModel, validateGPTImage15Params, validateDALLE2Params, validateSeedream45Params, getPromptLimitForModel } from '../lib/validation';
...
/**
 * Checks if we should use OpenRouter based on base URL.
 * Returns true if OPENAI_BASE_URL is set to OpenRouter's API endpoint.
 */
function shouldUseOpenRouter(): boolean {
  return process.env.OPENAI_BASE_URL === OPENROUTER_BASE_URL;
}
