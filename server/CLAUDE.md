...
This directory contains the Express.js backend server that handles API requests for the OpenDia. It provides RESTful endpoints for image generation using OpenAI's DALL-E 3 and GPT Image 1.5 APIs, configuration, and image format conversion.
