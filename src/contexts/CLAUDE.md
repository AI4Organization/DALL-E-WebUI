...
This directory contains React context providers that manage global state for the OpenDia. Contexts provide a way to share state between components without prop drilling.
